...
/// Проект представляет работу над модом в контексте редактора. 
/// Проект состоит из одного или нескольких репозиториев, т.к. 
/// бывает и клиентская, и серверная часть у одного мода
pub struct Project {
    pub name: String,
